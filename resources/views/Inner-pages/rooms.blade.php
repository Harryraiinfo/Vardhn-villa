        ...
        <div class="container">
            ...
            <div class="room-card" data-aos="fade-up" data-aos-delay="200">
                <div class="room-slider">
                    ...
                    <div><img src="{{ asset('images/Img/washrooms2.jpeg') }}" alt="Deluxe Room Washroom"></div>
                </div>
                <div class="room-info">
                    <h3>Deluxe Room</h3>
            ...
            {{-- Super Deluxe Room --}}
            <div class="room-card" data-aos="fade-up" data-aos-delay="200">
                <img src="{{ asset('images/Img/room3.jpeg') }}" alt="Super Deluxe Room">
                <div class="room-info">
            ...
            <div class="room-card" data-aos="fade-up" data-aos-delay="200">
                <div class="room-slider">
                    ...
                    <div><img src="{{ asset('images/Img/washrooms2.jpeg') }}" alt="Family Suite Washroom"></div>
