  ...
  <div class="container">
    <div class="row room-list fadeIn appear">
        ...
        <div class="room-thumb"> <img src="{{ asset('Images/Img/bed-room.jpeg')}}" alt="room 3" class="img-responsive" />
          <div class="mask">
            ...
            <div class="content">
              ...
              <a href="room-detail.html" class="btn btn-warning btn-block">Read More</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="room-thumb"> <img src="{{ asset('Images/Img/bed-room.jpeg')}}" alt="room 5" class="img-responsive" />
          <div class="mask">
            ...
            <div class="content">
              ...
              <a href="room-detail.html" class="btn btn-warning btn-block">Book Now</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-4 mt-4 single executive apartment">
        <div class="room-thumb">
          <img src="{{ asset('Images/Img/bed-room.jpeg')}}" alt="room 6" class="img-responsive" />
          <div class="mask">
            <div class="main row justify-content-center">
              <div class="col-7">
